...
- [[Insert + approve one distinct question per difficulty tier (avoids the     deter]] - `rationale_for` [EXTRACTED]
- [[PracticeQuestion]] - `calls` [EXTRACTED]
- [[decode_bearer_token()]] - `calls` [EXTRACTED]
- [[question_hash()]] - `calls` [EXTRACTED]
